                        ...
                        {user ? (
                            <>
                                ...
                                <Menu position="bottom-end" width={240}>
                                    <Menu.Target>
                                        <Avatar className="pointer" src={user.profilePicture && user.profilePicture.thumbnail} />
                                    </Menu.Target>
                                    <Menu.Dropdown>
                                        <Menu.Item
                                            onClick={() => navigate(`/${user.username}`)}
                                            leftSection={<Avatar src={user.profilePicture && user.profilePicture.thumbnail} />}
                                        >
                                            <Stack gap={4}>
